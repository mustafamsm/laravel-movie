        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2 justify-end" v-show="can['create seasons']">
                        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
                            <div class="p-1 flex items-center">
                                <label
                                    for="tmdb_id_g"
                                    class="block text-sm font-medium text-gray-700 mr-4"
                                >Seasons  Number</label
                                >
                    ...
                    >
                        ...
                        <div class="w-full overflow-x-auto">
                            <Table>
                                ...
                                <TableRow v-for="season in seasons.data"
                                          :key="season.id">
                                    ...
                                    <TableData>
                                        <div class="flex justify-around">
                                            <ButtonLink :link="route('admin.seasons.edit',[tvShow.id ,season.id])" v-show="can['edit seasons']">Edit</ButtonLink>
                                            <ButtonLink class="bg-teal-500 hover:bg-teal-700" :link="route('admin.episodes.index',[tvShow.id ,season.id])" v-show="can(['show episodes'])">Episodes</ButtonLink>

                                            <ButtonLink class="bg-red-500 hover:bg-red-700" method="delete" as="button" :link="route('admin.seasons.destroy', [tvShow.id ,season.id]) " v-show="can(['delete seasons'])">Delete
                                            </ButtonLink>
                                        </div>
                                    </TableData>
                                </TableRow>
...
function generateSeason() {
    router.post(`/admin/tv-shows/${props.tvShow.id}/seasons`
