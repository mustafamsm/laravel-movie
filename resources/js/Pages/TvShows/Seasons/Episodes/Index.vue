                    ...
                    >
                        ...
                        <div class="w-full overflow-x-auto">
                            <Table>
                                ...
                                <TableRow v-for="episode in episodes.data"
                                          :key="episode.id">
...
watch(search, value => {
    router.get(`/admin/tv-shows/${props.tvShow.id}/seasons/${props.season.id}/episodes`, {search: value, perPage: perPage.value},
        {
            preserveState: true,
            preserveScroll: true,
            replace: true
...
function getEpisodes() {
    router.get(`/admin/tv-shows/${props.tvShow.id}/seasons/${props.season.id}/episodes`, {perPage: perPage.value, search: search.value},
        {
            preserveState: true,
            preserveScroll: true,
            replace: true
...
function generateEpisode() {
    router.post(`/admin/tv-shows/${props.tvShow.id}/seasons/${props.season.id}/episodes`
